class GroupBillsController < ApplicationController
  before_action :fetch_group_bill, only: %i[show edit update destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @group_bill.save
        format.html { redirect_to group_bill_url(@group_bill), notice: 'Group bill created successfully.' }
  ...
  def update
    respond_to do |format|
      if @group_bill.update(group_bill_params)
        format.html { redirect_to group_bill_url(@group_bill), notice: 'Group bill updated successfully.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to group_bills_url, notice: 'Group bill deleted successfully.' }
