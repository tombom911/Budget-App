class BillsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bill.save
        format.html { redirect_to group_path(@bill.group_id), notice: 'Bill created successfully.' }
  ...
  def update
    respond_to do |format|
      if @bill.update(bill_params)
        format.html { redirect_to group_path(@bill.group_id), notice: 'Bill updated successfully.' }
